...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        let desc = `*👋 Hello ${pushname} 🌻 Have A Nice Day 🌻*
...
let about = ` *👋 𝐇𝐄𝐋𝐋𝐎𝐖 𝐓𝐇𝐄𝐈𝐑 ${senderNumber}*
              ...
              𝐈 𝐀𝐌 𝐐𝐔𝐄𝐄𝐍 𝐂𝐇𝐎𝐎𝐓𝐘 𝐍𝐄𝐋𝐔𝐌𝐈 𝐌𝐃 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐁𝐎𝐓

              𝐂𝐑𝐄𝐀𝐓𝐄𝐃 𝐁𝐘 𝐏𝐀𝐇𝐀𝐒𝐀𝐑𝐀 (𝐒𝐀𝐍𝐔𝐉𝐀 𝐏𝐀𝐇𝐀𝐒𝐀𝐑𝐀)..
           
*ɢɪᴛʜᴜʙ :*    
             
*ʏᴏᴜᴛᴜʙᴇ :* https://www.youtube.com/@Sl_nethumax
      
*ᴡʜᴀᴛꜱᴀᴘᴘ ᴄʜᴀɴɴᴇʟ :* https://whatsapp.com/channel/0029VagCogPGufJ3kZWjsW3A

              тнαηкѕ ƒσя υѕιɳɠ qυєєη ¢нσσту ηєℓυмι м∂ ωнαтѕαρρ вσт м∂ *ආං ඔයාට රෝස මල 🌹*`

return await conn.sendMessage(from,{image: {url: `https://i.ibb.co/vJhwvYf/Rf-Y1-Cy4-X9914.jpg`},caption:about},{quoted: mek})
...
*Youtube Channel Link:* https://www.youtube.com/@Sl_nethumax
...
✨ 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 𝐐𝐔𝐄𝐄𝐍 𝐂𝐇𝐎𝐎𝐓𝐘 𝐍𝐄𝐋𝐔𝐌𝐈 𝐌𝐃! ✨ 
╭─「 ᴄᴏᴍᴍᴀɴᴅꜱ ᴘᴀɴᴇʟ」
│◈ яυηтιмє * ${runtime(process.uptime())}
│◈ σωηєя ηαмє * 𝐒𝐀𝐍𝐔𝐉𝐀 𝐏𝐀𝐇𝐀𝐒𝐀𝐑𝐀
