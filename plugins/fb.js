...
async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        let desc = ` *QUEEN-CHOOTY-NELUMI-MD FB DOWNLOADE YOUR VIDEO Please Wait..💖*
...
> *©Qᴜᴇᴇɴ ᴄʜᴏᴏᴛʏ ɴᴇʟᴜᴍɪ ᴍᴅ*`;
        ...
        const vv = await conn.sendMessage(from, { image: { url: "https://i.ibb.co/jLvD1SY/je6-H0b-DW9671.jpg"}, caption: desc }, { quoted: mek });
