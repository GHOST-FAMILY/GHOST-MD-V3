...
let desc= `
 *🎶𝗤𝗨𝗘𝗘𝗡 𝗖𝗛𝗢𝗢𝗧𝗬 𝗡𝗘𝗟𝗨𝗠𝗜 𝗠𝗗 𝗔𝗨𝗗𝗜𝗢-𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗥🎶*
...
await conn.sendMessage(from,{document:{url:downloadUrl},mimetype:"audio/mpeg",fileName:deta.title + ".mp3" ,caption :"*Qᴜᴇᴇɴ ᴄʜᴏᴏᴛʏ ɴᴇʟᴜᴍɪ ᴍᴅ*"},{quoted:mek})
...
let desc= `
*📽️𝗤𝗨𝗘𝗘𝗡 𝗖𝗛𝗢𝗢𝗧𝗬 𝗡𝗘𝗟𝗨𝗠𝗜 𝗠𝗗 𝗩𝗜𝗗𝗘𝗢-𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗥📽️*
|__________________________
| ℹ️ *title* : *${deta.title}*
| 📋 *description* : *${deta.description}*
| 🕘 *time* : *${deta.timestamp}*
...
await conn.sendMessage(from,{document:{url:downloadUrl},mimetype:"video/mp4",fileName:deta.title + ".mp4",caption :"*Qᴜᴇᴇɴ ᴄʜᴏᴏᴛʏ ɴᴇʟᴜᴍɪ ᴍᴅ*"},{quoted:mek})
